    ...
    rs.on('data', function (data: any) {
      ...
      if (key === '0x') {
        ...
        acctData.storage['0x00'] =
          typeof acctData.storage['0x00'] !== 'undefined'
            ? acctData.storage['0x00']
            : acctData.storage['0x']
...
export function verifyGas(results: any, testData: any, t: tape.Test) {
  ...
  const preBal =
    typeof testData.pre[coinbaseAddr] !== 'undefined' ? testData.pre[coinbaseAddr].balance : 0

  if (typeof testData.post[coinbaseAddr] === 'undefined') {
    return
  }
...
export function verifyLogs(logs: any, testData: any, t: tape.Test) {
  if (typeof testData.logs !== 'undefined') {
...
export async function setupPreConditions(state: VmState, testData: any) {
  ...
  for (const addressStr of Object.keys(testData.pre)) {
    ...
    if (typeof testData.exec !== 'undefined' && testData.exec.address === addressStr) {
